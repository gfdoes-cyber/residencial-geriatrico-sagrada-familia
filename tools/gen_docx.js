...
while (i < lines.length) {
  ...
  if (line.startsWith('@@ ')) { flushPara(); children.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { line: 360, after: 120 }, children: runsFromInline(line.slice(3)) })); i++; continue; }
